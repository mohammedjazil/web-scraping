...
for i in range(0,len(df_jaz_mart)):
    ...
    URL =f"https://shop.thefreshmarket.com/api/v2/store_products?ads_enabled=true&ads_pagination_improvements=true&limit=5&offset=0&page=1&prophetScorer=frequency&sort=rank&allow_autocorrect=true&search_is_autocomplete=false&search_provider=ic&search_term={searchinput}&secondary_results=true&unified_search_shadow_test_enabled=false"
